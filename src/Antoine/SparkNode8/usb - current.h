...
#define USB_PID_ATMEL_TEST_VENDOR_CLASS	0x2040
#define USB_DEVICE_MAJOR_VERSION		1
#define USB_DEVICE_MINOR_VERSION		0
#define USB_REQ_GetMSDescriptor			u'.'

typedef size_t usb_size;
typedef uint8_t usb_ep;
typedef uint8_t usb_bank;

__attribute__((__aligned__(4))) USB_SetupPacket usb_setup;
__attribute__((__aligned__(4))) uint8_t ep0_buf_in[8*USB_EP0_SIZE];
__attribute__((__aligned__(4))) uint8_t ep0_buf_out[8*USB_EP0_SIZE];
