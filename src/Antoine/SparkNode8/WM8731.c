...
**************************************************************************************************/
const unsigned int _WM8731_left_lineIn        = 0x0117;     // Line in 0dB
const unsigned int _WM8731_Right_lineIn       = 0x0117;     // Mic settings: Enable mute, Enable simultaneous load to left and right channels
...
const unsigned int _WM8731_AnalogAudio        = 0x14;       // DAC Select and inSEL
const unsigned int _WM8731_DigitalAudio       = 0x06;
const unsigned int _WM8731_power              = 0x02;       // Disable Power down
const unsigned int _WM8731_DAIF               = 0x42;		// master i2s 16 bits
const unsigned int _WM8731_Sampling           = 0x00;		// fs = 48 khz (ADC and DAC), normal mode
//const unsigned int _WM8731_Sampling           = 0x0c;		// fs = 8 khz (ADC and DAC), normal mode
//const unsigned int _WM8731_Sampling           = 0x18;		// fs = 32 khz (ADC and DAC), normal mode
